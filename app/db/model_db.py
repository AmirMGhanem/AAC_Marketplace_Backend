...
class TCity(Base):
    ...
    city_state_code = Column(VARCHAR(2), index=True)
...
class TCategory(Base):
    ...
    category_vertical_id = Column(ForeignKey('db_marketplace.T_vertical.vertical_id'), index=True, server_default=text("'1'"))
