...
Revision ID: 7dba049c37ca
Revises: 65e42aea4799
Create Date: 2023-03-02 11:39:43.534143
...
revision = '7dba049c37ca'
down_revision = '65e42aea4799'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    op.drop_constraint(None, 'T_lead', schema='db_marketplace', type_='foreignkey')
    op.drop_constraint(None, 'T_lead', schema='db_marketplace', type_='foreignkey')
    op.create_foreign_key('t_lead_ibfk_1', 'T_lead', 'T_category', ['lead_category_id'], ['category_id'])
    op.create_foreign_key('t_lead_ibfk_3', 'T_lead', 'T_affiliate', ['lead_affiliate_id'], ['affiliate_id'])
